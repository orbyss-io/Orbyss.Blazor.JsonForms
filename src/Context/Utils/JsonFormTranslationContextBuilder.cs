...
public static class JsonFormTranslationContextBuilder
{
    ...
    {
        return BuildAndInstantiate(translationSchema, jsonSchema, JsonPathInterpreter.Default);
    }

    public static IJsonFormTranslationContext BuildAndInstantiate(string translationSchemaJson, string jsonSchema)
    {
        return BuildAndInstantiate(translationSchemaJson, jsonSchema, JsonPathInterpreter.Default);
    }
