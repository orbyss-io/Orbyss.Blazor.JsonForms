...
{
    public static bool HasOption(object? options, string key)
    {
        return TryGetOption(options, key, out _);
    }

    public static JToken GetOption(object? options, string key)
    {
        return TryGetOption(options, key, out var result)
    ? result!
