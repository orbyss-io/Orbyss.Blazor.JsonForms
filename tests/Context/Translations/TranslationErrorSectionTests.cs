...
namespace Orbyss.Components.JsonForms.Tests.Context.Translations
{
    ...
    public class TranslationErrorSectionTests
    {
        ...
        public void When_GetValue_Then_Returns_Value_For_ErrorType()
        {
            ...
            // Act
            var constError = sut.GetValue(ErrorType.Const);
            var requiredError = sut.GetValue(ErrorType.Required);
            var minimumError = sut.GetValue(ErrorType.Minimum);
            var maximumError = sut.GetValue(ErrorType.Maximum);
            var minLengthError = sut.GetValue(ErrorType.MinimumLength);
            var maxLengthError = sut.GetValue(ErrorType.MaximumLength);
            var minItemsError = sut.GetValue(ErrorType.MinimumItems);
            var maxItemsError = sut.GetValue(ErrorType.MaximumItems);
            var containsError = sut.GetValue(ErrorType.Contains);
            var patternError = sut.GetValue(ErrorType.Pattern);
